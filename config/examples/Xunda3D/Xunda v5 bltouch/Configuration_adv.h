 ...
 */
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only JK
...
//#define CUSTOM_USER_BUTTONS
  ...
  //#define BUTTON1_PIN -1
    ...
    #define BUTTON1_GCODE         "M600"
    #define BUTTON1_DESC          "Filament Change"  // Optional string to set the LCD status
  #endif
