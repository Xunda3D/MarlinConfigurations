...
#define STRING_CONFIG_H_AUTHOR "Xunda Tech Ug" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Xunda Bot v5"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "6a5b897a-c068-484a-a837-f62ff162ce5e"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 90
  #define DEFAULT_bedKi 15
  #define DEFAULT_bedKd 360
...
// These 3 lines are customizable for your board.
//#define USE_XMIN_PLUG   //JK
//#define USE_YMIN_PLUG
//#define USE_ZMIN_PLUG    //JK

// Enable pullup for all endstops to prevent a floating state
#define ENDSTOPPULLUPS        //JK
...
//#define ENDSTOPPULLDOWNS  //JK enabled. Disabled in default.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 142.8 }
/**
 ...
 */
#define DEFAULT_ACCELERATION           3000    // X, Y, Z and E acceleration for printing moves. default 500 for all JK
...
#define DEFAULT_EJERK 5.0  //May be used by linear advance, Added by JK
/**
 ...
 */
//#define Z_MIN_PROBE_PIN PC2 //JK, used the endstop pin for Z probe
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 0, 0 }   //JK (10,10,0)
...
#define PROBE_OFFSET_ZMIN -20   // (mm) JK enabled. Default is disabled
#define PROBE_OFFSET_ZMAX  20   // (mm) JK enabled. Default is disabled
...
#define Y_BED_SIZE 200 //This is the size of the printable area, not the bed size.
 ...
 */
#define Z_SAFE_HOMING   //JK, disabled by default.
...
#define HOMING_FEEDRATE_MM_M { 70*60,70*60,30*60 } // (mm/min) Speed for X, Y, Z axes JK from 120,120,120
